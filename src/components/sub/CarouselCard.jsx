...
function CarouselCard() {
  return (
    <div>
      <div>
        <div className=" py-8   flex   pl-14 justify-between items-center">
          <div className=" relative right-10 z-10" id="card image">
            <img
              className="  shadow-green-700 shadow-lg w-[500px] h-[350px] rounded-lg object-cover"
              src="/plant.jpg"
            />
          </div>
          <div
            id="rest-carousel"
            className="relative -top-1   -left-16    z-0 overflow-hidden py-[20px] px-[50px] bg-darkBg flex items-start flex-col gap-4"
          >
            <div className=" ">
              <div
              ...
              <p className=" text-[40px] leading-snug font-bold text-myWhite">
                Your most unhappy customers are your greatest source of learning
              </p>
              <p className=" leading-10  text-[14px] font-medium opacity-75  text-mygray">
